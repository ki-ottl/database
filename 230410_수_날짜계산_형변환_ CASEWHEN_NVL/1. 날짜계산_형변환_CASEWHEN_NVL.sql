...
SELECT A.*,
    NVL(VOLUME, 20) AS NVL_EX, -- CASE WHEN VOLUME IS NULL THEN 20 ELSE VOLUME END AS NVL_EX
    NVL2(VOLUME, VOLUME * 1.5, 20) AS NVL2_EX  -- CASE WHEN IS NULL THEN 20 ELSE VOLUME * 1.5 END AS NVL2_EX
FROM NVL_CHECK A;
